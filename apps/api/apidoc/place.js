/**
 * @api {get} /api/place 모든 장소 조회
 * @apiDescription 모든 장소 확인
 * @apiGroup Place
 *
  ...
  "list": [
    {
      ...
      "population": {
        ...
        "resident": 52,
        "nonResident": 48,
        "createdDate": "2025-12-31T02:54:53.181Z",
        "updatedDate": "2025-12-31T02:54:53.181Z"
      }
    },
  ],
  "count": 120
...
/**
 * @api {get} /api/place/:idx 특정 장소 조회
 * @apiDescription 특정 장소 확인
 * @apiGroup Place
 *
 ...
 * @apiSuccess {Place[]} locations.places 장소 리스트
 *
 * @apiSuccessExample Response (example):
 * HTTP/1.1 200 OK
 * {
  ...
  "population": {
    ...
    "resident": 53,
    "nonResident": 47,
    "createdDate": "2025-12-31T02:54:52.262Z",
    "updatedDate": "2025-12-31T02:54:52.262Z"
  },
  "accidents": [],
  "cctvs": [
    {
    ...
    "places": [
      {
        ...
        "population": {
          ...
          "resident": 47,
          "nonResident": 53,
          "createdDate": "2025-12-31T02:54:52.912Z",
          "updatedDate": "2025-12-31T02:54:52.912Z"
        }
      },
    ]
  }
